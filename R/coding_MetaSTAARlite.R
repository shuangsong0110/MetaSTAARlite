#' Performs meta-analysis of coding functional categories using MetaSTAARlite
#'
...
#' @return a list of data frames containing the MetaSTAAR p-values (including MetaSTAAR-O) corresponding to each coding functional category of the given gene.
