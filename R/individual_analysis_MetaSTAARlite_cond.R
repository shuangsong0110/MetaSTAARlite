#' Performs conditional meta-analysis of individual variants by using the MetaSTAARlite pipeline.
#'
...
#' @param individual_results a dataframe containing the unconditional results of the meta-analysis.
