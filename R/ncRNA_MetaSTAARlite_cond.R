#' Performs conditional meta-analysis of ncRNA functional categories by using the MetaSTAARlite pipeline.
#'
...
#' @param variant_type a character specifying the type(s) of variant included in the analysis. Choices include
...
#' @return a list of data frames containing the MetaSTAAR p-values (including MetaSTAAR-O) corresponding to the coding
#'  functional category of the given gene.
