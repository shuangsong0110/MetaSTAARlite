#' Performs conditional meta-analysis of long noncoding RNA (ncRNA) category using MetaSTAARlite
#'
#' This function performs meta-analysis to detect conditional associations between a
#' quantitative/dichotomous phenotype and the exonic and splicing category of an ncRNA gene
...
#' @param ncRNA_cov_cond_gene_list a list containing study-specific summary statistics and covariance matrices
...
#' @return a list of data frames containing the conditional MetaSTAAR p-values (including MetaSTAAR-O) corresponding to
