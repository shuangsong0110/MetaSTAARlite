#' Performs conditional meta-analysis of noncoding functional categories using MetaSTAARlite
#'
#' This function performs meta-analysis to detect conditional associations between a
#' quantitative/dichotomous phenotype and noncoding functional categories of a gene
...
#' @return a list of data frames containing the conditional MetaSTAAR p-values (including MetaSTAAR-O) corresponding to each noncoding functional category of the given gene.
